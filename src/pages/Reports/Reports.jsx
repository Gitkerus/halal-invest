    ...
    <>
      ...
      <ol>
        <li>
          ...
          Предоставление полной и подробной информации о финансовых показателях
          нашей компании, включая балансовую отчетность, отчет о прибылях и
          убытках, а также отчет о движении денежных средств.
        </li>
        <li>
          <b>Инвестиционные стратегии</b> <br />
          Разъяснение наших инвестиционных стратегий, которые включают
          диверсификацию портфеля, консервативное управление рисками и строгое
          соответствие принципам исламского финансирования.
        </li>
        <li>
          <b>Прозрачность операций</b> <br />
          Предоставление информации о наших операциях, включая сделки с акциями,
          облигациями и другими финансовыми инструментами. Мы придерживаемся
          наивысших стандартов прозрачности и отчетности.
        </li>
        <li>
          <b>Политика конфиденциальности</b> <br />
          Обеспечение безопасности и конфиденциальности наших инвесторов - наш
          приоритет. Мы следуем строгой политике конфиденциальности и не
          передаем личную информацию третьим лицам.
        </li>{" "}
      </ol>
      <br />
      Всегда готовы ответить на ваши вопросы и обсудить возможности
      инвестирования, соответствующие вашим целям и потребностям. Наша команда
      экспертов всегда готова помочь вам принять правильное инвестиционное
      решение. Присоединяйтесь к нам и начните свой путь к успешным и халяльным
      инвестициям уже сегодня! Если у вас возникли какие-либо вопросы,
      пожалуйста, обратитесь к нашей службе поддержки по контактным данным,
      указанным на нашем сайте. Мы будем рады помочь вам!
    </>
  ),
