...
const KeyInfo_data = {
  ...
  data: [
    ...
    },
    {
      ...
      text: "Ситуация на фондовом рынке развивается хуже чем ожидания аналитиков, вероятность такого сценария ниже чем вероятность нейтрального, мы используем стоп лосс на падении акции",
      path: "",
    },
  ],
};
